<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
            <i class="menu-icon tf-icons bx bx-store"></i>
            <div data-i18n="Front Pages">Stores</div>
        ...
        <ul class="menu-sub">
            <li class="menu-item">
                <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/landing-page.html"
                    class="menu-link" target="_blank">
                    <div data-i18n="Landing">Add New Store</div>
                </a>
            </li>
            <li class="menu-item">
                <a href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/front-pages/pricing-page.html"
                    class="menu-link" target="_blank">
                    <div data-i18n="Pricing">All Stores</div>
                </a>
            </li>
        </ul>
    </li>
     ...
     <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <div data-i18n="Clients">Stores</div>
        </a>
        <ul class="menu-sub">
            <li class="menu-item">
                <a href="store-owner-dashboard.html" class="menu-link">
                    <div data-i18n="Store Owner Dashboard">All Stores</div>
                </a>
            </li>
            <li class="menu-item">
                <a href="add-store-owner.html" class="menu-link">
                    <div data-i18n="Add Store Owner">Add Store </div>
                </a>
            </li>
            <li class="menu-item">
                <a href="manage-store-owners.html" class="menu-link">
                    <div data-i18n="Manage Store Owners">Manage Stores</div>
                </a>
            </li>
        </ul>
    </li>
